...
#define COUNTS_PER_REV1 11              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 11              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 11              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 11              // wheel4 encoder's no of ticks per rev
